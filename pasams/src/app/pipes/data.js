...
function getBasicData(rows) {
    ...
    var firstNames = ['Ted', 'John', 'Macy', 'Rob', 'Gwen', 'Fiona', 'Mario',
        'Ben', 'Kate', 'Kevin', 'Thomas', 'Frank'];
    var lastNames = ['Tired', 'Johnson', 'Moore', 'Rocket', 'Goodman', 'Farewell',
        'Manson', 'Bentley', 'Kowalski', 'Schmidt', 'Tucker', 'Fancy'];
    var address = ['Turkey', 'Japan', 'Michigan', 'Russia', 'Greece', 'France', 'USA',
...
exports.getAdvancedData = getAdvancedData;
...
exports.getScienceData = getScienceData;
...
exports.getSportData = getSportData;
